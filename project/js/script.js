...
function addMovies() {
    ...
    movies.forEach(function(movie) {
       ...
       movieItem.innerHTML = `${movie.Title}<div class="delete"></div>`;
       movieList.appendChild(movieItem);

        movieItem.addEventListener('click', function() {
        promoBg.style.backgroundImage = `url(${movie.Poster})`;
        promoBg.querySelector('.promo__genre').textContent = movie.Genre;
        promoBg.querySelector('.promo__title').textContent = movie.Title;
        promoBg.querySelector('.promo__descr').textContent = movie.Description;
       });
       movieItem.querySelector('.delete').addEventListener('click', function() {
 ...
 function addGenres() {
    ...
    genres.forEach(function(genre) {
       ...
       genreItem.innerHTML = `<a class="genre__item" href="#">${genre}</a>`;
       genreList.appendChild(genreItem);
    });
    document.querySelector('.promo__menu-list').appendChild(genreList);
 
    let genreItems = document.querySelectorAll('.genre__item');
    genreItems.forEach(function(item) {
       item.addEventListener('click', function() {
          let currentGenre = item.textContent;
          let movieList = document.querySelector('.promo__interactive-list');
          movieList.innerHTML = '';
          movies.forEach(function(movie) {
